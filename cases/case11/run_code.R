...
#### Run OM ####
OM_Run(maindir=maindir, subdir="OM", om_sim_num=om_sim_num, r_dev_matrix=r_dev_matrix, f_dev_matrix=f_dev_matrix, f_matrix=f_matrix, om_bias_cor=om_bias_cor, catch_data_year=1:30, catch_age_data_year=11:30, survey_index_year=11:30, survey_age_data_year=11:30)
...
#source(file.path(maindir, "plot_output_adhoc.R"))
