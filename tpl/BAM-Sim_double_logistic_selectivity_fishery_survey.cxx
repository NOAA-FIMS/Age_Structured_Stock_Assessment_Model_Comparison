...
open_r_df("parm.cons",1,8,2);
	...
	wrt_r_df_col("selpar_A501_survey1",selpar_A501_survey1_out);
    wrt_r_df_col("selpar_slope1_survey1",selpar_slope1_survey1_out);
    wrt_r_df_col("selpar_A502_survey1",selpar_A502_survey1_out);
    wrt_r_df_col("selpar_slope2_survey1",selpar_slope2_survey1_out);
	
	wrt_r_df_col("selpar_A501_fleet1_B1",selpar_A501_fleet1_B1_out);
    wrt_r_df_col("selpar_slope1_fleet1_B1",selpar_slope1_fleet1_B1_out);
    wrt_r_df_col("selpar_A502_fleet1_B1",selpar_A502_fleet1_B1_out);
    wrt_r_df_col("selpar_slope2_fleet1_B1",selpar_slope2_fleet1_B1_out);
    
 	wrt_r_df_col("selpar_A501_fleet1_B2",selpar_A501_fleet1_B2_out);
    wrt_r_df_col("selpar_slope1_fleet1_B2",selpar_slope1_fleet1_B2_out);
    wrt_r_df_col("selpar_A502_fleet1_B2",selpar_A502_fleet1_B2_out);
    wrt_r_df_col("selpar_slope2_fleet1_B2",selpar_slope2_fleet1_B2_out);
