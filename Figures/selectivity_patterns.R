#### Plot base case ####
maindir = "C:/Users/bai.li/Desktop/mcp_results_r/cases/case2_1/output"
...
jpeg(file="C:\\Users\\bai.li\\Desktop\\mcp_results_r\\cases\\manuscript_figures\\selectivity_patterns.jpg", width=150, height=100, units="mm", res=300)
...
plot(om_input$ages, om_input$selex_fleet$fleet1, type="o", col=alpha("black", 0.5),
     xlab="", ylab="", pch=19, panel.first=grid(lty=1), cex=0.6, ylim=c(0,1))
...
#### Plot case 5_2 ####
maindir = "C:/Users/bai.li/Desktop/mcp_results_r/cases/case5_1_doublelogistic_fleetsurvey/output"
setwd(maindir)
