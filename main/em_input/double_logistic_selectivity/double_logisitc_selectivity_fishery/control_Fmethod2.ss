...
#0	0.02297737	0.32082130	0.90465054	0.99477987	0.99973881	0.99998699	0.99999935	0.99999997	1	1	1	1 #OP4_Maturity*Fecundity
#0	0.01219307	0.3838076	1.86201093	3.01914427	4.05415325	5.0646316	6.02622227	6.91692035	7.72489084	8.44611278	9.08185325	9.63669498 #OP4_Maturity*Fecundity*Weight(kg)_BetterFit
1 #_First_Mature_Age
...
0.01 0.5 0.2 0.2 0.4 0 -2 0 0 0 0 0 0 0 # NatM_p_1_Fem_GP_1
# Sex: 1  BioPattern: 1  Growth
10	60	27.68796	27.68796	0.25	0	-3	0	0	0	0	0	0	0	#L_at_Amin_Fem_GP_1
40	120	80	80	0.25	0	-3	0	0	0	0	0	0	0	#L_at_Amax_Fem_GP_1
0.01	1	0.18	0.18	0.25	0	-3	0	0	0	0	0	0	0	#VonBert_K_Fem_GP_1
0.05	0.25	0.1	0.1	0.25	0	-4	0	0	0	0	0	0	0	#CV_young_Fem_GP_1
0.05	0.25	0.1	0.1	0.25	0	-4	0	0	0	0	0	0	0	#CV_old_Fem_GP_1
# Sex: 1  BioPattern: 1  WtLen
-3	3	0.000025	0.000025	0.25	0	-3	0	0	0	0	0	0	0	#Wtlen_1_Fem_GP_1
-3	4	3	3	0.25	0	-3	0	0	0	0	0	0	0	#Wtlen_2_Fem_GP_1
# Sex: 1  BioPattern: 1  Maturity&Fecundity
1	5	2.25	2.25	0.25	0	-3	0	0	0	0	0	0	0	#Mat50%_Fem_GP_1
-6	6	-3	-3	0.25	0	-3	0	0	0	0	0	0	0	#Mat_slope_Fem_GP_1
-3	3	1	1	0.8	0	-3	0	0	0	0	0	0	0	#Eggs/kg_a_Fem_GP_1_FECOP1
-3	3	0	0	0.8	0	-3	0	0	0	0	0	0	0	#Eggs/kg_b_wt_Fem_GP_1_FECOP1
# Hermaphroditism
#  Recruitment Distribution  
#  Cohort growth dev base
0.1 10 1 1 0.8 0 -3 0 0 0 0 0 0 0 # CohortGrowDev
#  Movement
#  Age Error from parameters
#  catch multiplier
#  fraction female, by GP
0.001 0.999 0.5 0.5 0.5 0 -3 0 0 0 0 0 0 0 # FracFemale_GP_1
#
...
30 # last year of main recr_devs; forecast devs start in following year
2 #_recdev phase 
...
0.2 # F ballpark
-2 # F ballpark year (neg value to disable)
2 # F_Method:  1=Pope; 2=instan. F; 3=hybrid (hybrid is recommended)
4 # max F or harvest rate, depends on F_Method
# no additional F input needed for Fmethod 1
# if Fmethod=2; read overall start F value; overall phase; N detailed inputs to read
# if Fmethod=3; read N iterations for tuning for Fmethod 3
0.009459165 1 0 # overall start F value; overall phase; N detailed inputs to read
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
# 1   FISHERY1 AgeSelex
0 12 4 4 1 0 2 0 0 0 0 0 0 0 # AgeSel_1P_1_Fishery
0 12 1 1 1 0 2 0 0 0 0 0 0 0 # AgeSel_1P_2_Fishery1 
0 12 11 11 1 0 2 0 0 0 0 0 0 0 # AgeSel_1P_3_Fishery
0 12 0.7 0.7 1 0 2 0 0 0 0 0 0 0 # AgeSel_1P_4_Fishery1 
0 12 1 1 1 0 2 0 0 0 0 0 0 0 # AgeSel_1P_5_Fishery
