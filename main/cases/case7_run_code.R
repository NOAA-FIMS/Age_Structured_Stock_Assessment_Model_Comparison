...
f_matrix <- f_case(f_pattern=6, f_min=NULL, f_max=NULL, f_end=NULL, f_mean=0.19, start_val=0.01, start_year=7, nyr=nyr, om_sim_num=om_sim_num, f_dev_matrix=f_dev_matrix)
