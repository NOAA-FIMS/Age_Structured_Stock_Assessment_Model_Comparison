...
f_matrix <- f_case(f_pattern=3, f_min=0.01, f_max=0.39, f_end=0.08, f_mean=NULL, start_val=NULL, start_year=NULL, nyr=nyr, om_sim_num=om_sim_num, f_dev_matrix=f_dev_matrix)
