...
init_vector set_selpar_A501_fleet1_B1(1,7);  //Block one A501
init_vector set_selpar_slope1_fleet1_B1(1,7);//Block one slope1
init_vector set_selpar_A502_fleet1_B1(1,7);  //Block one A502
init_vector set_selpar_slope2_fleet1_B1(1,7);//Block one slope2
init_vector set_selpar_A501_fleet1_B2(1,7);  //Block two A501; not used in simulation
init_vector set_selpar_slope1_fleet1_B2(1,7);//Block two slope1; not used in simulation
init_vector set_selpar_A502_fleet1_B2(1,7);  //Block two A502; not used in simulation
init_vector set_selpar_slope2_fleet1_B2(1,7);//Block two slope2; not used in simulation

init_vector set_selpar_A501_survey1(1,7);  //Survey A501
init_vector set_selpar_slope1_survey1(1,7);//Survey slope1
init_vector set_selpar_A502_survey1(1,7);  //Survey A502
init_vector set_selpar_slope2_survey1(1,7);//Survey slope2
...
//this section MUST BE INDENTED!!!
 ...
 LOCAL_CALCS
  ...
  const double selpar_A501_survey1_LO=set_selpar_A501_survey1(2); const double selpar_A501_survey1_HI=set_selpar_A501_survey1(3); const double selpar_A501_survey1_PH=set_selpar_A501_survey1(4);
  const double selpar_slope1_survey1_LO=set_selpar_slope1_survey1(2); const double selpar_slope1_survey1_HI=set_selpar_slope1_survey1(3); const double selpar_slope1_survey1_PH=set_selpar_slope1_survey1(4);
  const double selpar_A502_survey1_LO=set_selpar_A502_survey1(2); const double selpar_A502_survey1_HI=set_selpar_A502_survey1(3); const double selpar_A502_survey1_PH=set_selpar_A502_survey1(4);
  const double selpar_slope2_survey1_LO=set_selpar_slope2_survey1(2); const double selpar_slope2_survey1_HI=set_selpar_slope2_survey1(3); const double selpar_slope2_survey1_PH=set_selpar_slope2_survey1(4);

  const double selpar_A501_fleet1_B1_LO=set_selpar_A501_fleet1_B1(2); const double selpar_A501_fleet1_B1_HI=set_selpar_A501_fleet1_B1(3); const double selpar_A501_fleet1_B1_PH=set_selpar_A501_fleet1_B1(4);
  const double selpar_slope1_fleet1_B1_LO=set_selpar_slope1_fleet1_B1(2); const double selpar_slope1_fleet1_B1_HI=set_selpar_slope1_fleet1_B1(3); const double selpar_slope1_fleet1_B1_PH=set_selpar_slope1_fleet1_B1(4);
  const double selpar_A502_fleet1_B1_LO=set_selpar_A502_fleet1_B1(2); const double selpar_A502_fleet1_B1_HI=set_selpar_A502_fleet1_B1(3); const double selpar_A502_fleet1_B1_PH=set_selpar_A502_fleet1_B1(4);
  const double selpar_slope2_fleet1_B1_LO=set_selpar_slope2_fleet1_B1(2); const double selpar_slope2_fleet1_B1_HI=set_selpar_slope2_fleet1_B1(3); const double selpar_slope2_fleet1_B1_PH=set_selpar_slope2_fleet1_B1(4);
  
  const double selpar_A501_fleet1_B2_LO=set_selpar_A501_fleet1_B2(2); const double selpar_A501_fleet1_B2_HI=set_selpar_A501_fleet1_B2(3); const double selpar_A501_fleet1_B2_PH=set_selpar_A501_fleet1_B2(4);
  const double selpar_slope1_fleet1_B2_LO=set_selpar_slope1_fleet1_B2(2); const double selpar_slope1_fleet1_B2_HI=set_selpar_slope1_fleet1_B2(3); const double selpar_slope1_fleet1_B2_PH=set_selpar_slope1_fleet1_B2(4);
  const double selpar_A502_fleet1_B2_LO=set_selpar_A502_fleet1_B2(2); const double selpar_A502_fleet1_B2_HI=set_selpar_A502_fleet1_B2(3); const double selpar_A502_fleet1_B2_PH=set_selpar_A502_fleet1_B2(4);
  const double selpar_slope2_fleet1_B2_LO=set_selpar_slope2_fleet1_B2(2); const double selpar_slope2_fleet1_B2_HI=set_selpar_slope2_fleet1_B2(3); const double selpar_slope2_fleet1_B2_PH=set_selpar_slope2_fleet1_B2(4);
...
//survey1 selectivity-------------------------------------------------
  ...
  init_bounded_number selpar_A501_survey1(selpar_A501_survey1_LO,selpar_A501_survey1_HI,selpar_A501_survey1_PH);
  init_bounded_number selpar_slope1_survey1(selpar_slope1_survey1_LO,selpar_slope1_survey1_HI,selpar_slope1_survey1_PH);
  init_bounded_number selpar_A502_survey1(selpar_A502_survey1_LO,selpar_A502_survey1_HI,selpar_A502_survey1_PH);
  init_bounded_number selpar_slope2_survey1(selpar_slope2_survey1_LO,selpar_slope2_survey1_HI,selpar_slope2_survey1_PH);
  vector selpar_A501_survey1_out(1,8);
  vector selpar_slope1_survey1_out(1,8);
  vector selpar_A502_survey1_out(1,8);
  vector selpar_slope2_survey1_out(1,8);
...
//fleet1 catch selectivity-------------------------------------------------
  ...
  init_bounded_number selpar_A501_fleet1_B1(selpar_A501_fleet1_B1_LO,selpar_A501_fleet1_B1_HI,selpar_A501_fleet1_B1_PH);
  init_bounded_number selpar_slope1_fleet1_B1(selpar_slope1_fleet1_B1_LO,selpar_slope1_fleet1_B1_HI,selpar_slope1_fleet1_B1_PH);
  init_bounded_number selpar_A502_fleet1_B1(selpar_A502_fleet1_B1_LO,selpar_A502_fleet1_B1_HI,selpar_A502_fleet1_B1_PH);
  init_bounded_number selpar_slope2_fleet1_B1(selpar_slope2_fleet1_B1_LO,selpar_slope2_fleet1_B1_HI,selpar_slope2_fleet1_B1_PH);
  
  init_bounded_number selpar_A501_fleet1_B2(selpar_A501_fleet1_B2_LO,selpar_A501_fleet1_B2_HI,selpar_A501_fleet1_B2_PH);
  init_bounded_number selpar_slope1_fleet1_B2(selpar_slope1_fleet1_B2_LO,selpar_slope1_fleet1_B2_HI,selpar_slope1_fleet1_B2_PH);
  init_bounded_number selpar_A502_fleet1_B2(selpar_A502_fleet1_B2_LO,selpar_A502_fleet1_B2_HI,selpar_A502_fleet1_B2_PH);
  init_bounded_number selpar_slope2_fleet1_B2(selpar_slope2_fleet1_B2_LO,selpar_slope2_fleet1_B2_HI,selpar_slope2_fleet1_B2_PH);
  
  vector selpar_A501_fleet1_B1_out(1,8);
  vector selpar_slope1_fleet1_B1_out(1,8);
  vector selpar_A502_fleet1_B1_out(1,8);
  vector selpar_slope2_fleet1_B1_out(1,8);
  
  vector selpar_A501_fleet1_B2_out(1,8);
  vector selpar_slope1_fleet1_B2_out(1,8);
  vector selpar_A502_fleet1_B2_out(1,8);
  vector selpar_slope2_fleet1_B2_out(1,8);
...
// Set values of fixed parameters or set initial guess of estimated parameters
  ...
  selpar_A501_survey1=set_selpar_A501_survey1(1);
  selpar_slope1_survey1=set_selpar_slope1_survey1(1);
  selpar_A502_survey1=set_selpar_A502_survey1(1);
  selpar_slope2_survey1=set_selpar_slope2_survey1(1);
 
  selpar_A501_fleet1_B1=set_selpar_A501_fleet1_B1(1);
  selpar_slope1_fleet1_B1=set_selpar_slope1_fleet1_B1(1);
  selpar_A502_fleet1_B1=set_selpar_A502_fleet1_B1(1);
  selpar_slope2_fleet1_B1=set_selpar_slope2_fleet1_B1(1);
  
  selpar_A501_fleet1_B2=set_selpar_A501_fleet1_B2(1);
  selpar_slope1_fleet1_B2=set_selpar_slope1_fleet1_B2(1);
  selpar_A502_fleet1_B2=set_selpar_A502_fleet1_B2(1);
  selpar_slope2_fleet1_B2=set_selpar_slope2_fleet1_B2(1);
...
FUNCTION get_selectivity    
  selvec_survey1=logistic_double(agebins, selpar_A501_survey1, selpar_slope1_survey1, selpar_A502_survey1, selpar_slope2_survey1);	
  selvec_fleet1_B1=logistic_double(agebins, selpar_A501_fleet1_B1, selpar_slope1_fleet1_B1, selpar_A502_fleet1_B1, selpar_slope2_fleet1_B1);  
...
//pdf type 1=none, 2=lognormal, 3=normal, 4=beta 
  ...
  f_priors+=neg_log_prior(selpar_A501_survey1,set_selpar_A501_survey1(5), set_selpar_A501_survey1(6), set_selpar_A501_survey1(7));
  f_priors+=neg_log_prior(selpar_slope1_survey1,set_selpar_slope1_survey1(5), set_selpar_slope1_survey1(6), set_selpar_slope1_survey1(7));
  f_priors+=neg_log_prior(selpar_A502_survey1,set_selpar_A502_survey1(5), set_selpar_A502_survey1(6), set_selpar_A502_survey1(7));
  f_priors+=neg_log_prior(selpar_slope2_survey1,set_selpar_slope2_survey1(5), set_selpar_slope2_survey1(6), set_selpar_slope2_survey1(7));
    
  f_priors+=neg_log_prior(selpar_A501_fleet1_B1,set_selpar_A501_fleet1_B1(5), set_selpar_A501_fleet1_B1(6), set_selpar_A501_fleet1_B1(7));
  f_priors+=neg_log_prior(selpar_slope1_fleet1_B1,set_selpar_slope1_fleet1_B1(5), set_selpar_slope1_fleet1_B1(6), set_selpar_slope1_fleet1_B1(7));
  f_priors+=neg_log_prior(selpar_A502_fleet1_B1,set_selpar_A502_fleet1_B1(5), set_selpar_A502_fleet1_B1(6), set_selpar_A502_fleet1_B1(7));
  f_priors+=neg_log_prior(selpar_slope2_fleet1_B1,set_selpar_slope2_fleet1_B1(5), set_selpar_slope2_fleet1_B1(6), set_selpar_slope2_fleet1_B1(7));
  
  f_priors+=neg_log_prior(selpar_A501_fleet1_B2,set_selpar_A501_fleet1_B2(5), set_selpar_A501_fleet1_B2(6), set_selpar_A501_fleet1_B2(7));
  f_priors+=neg_log_prior(selpar_slope1_fleet1_B2,set_selpar_slope1_fleet1_B2(5), set_selpar_slope1_fleet1_B2(6), set_selpar_slope1_fleet1_B2(7));
  f_priors+=neg_log_prior(selpar_A502_fleet1_B2,set_selpar_A502_fleet1_B2(5), set_selpar_A502_fleet1_B2(6), set_selpar_A502_fleet1_B2(7));
  f_priors+=neg_log_prior(selpar_slope2_fleet1_B2,set_selpar_slope2_fleet1_B2(5), set_selpar_slope2_fleet1_B2(6), set_selpar_slope2_fleet1_B2(7));
...
REPORT_SECTION
    ...
    if (last_phase())  
    {
      ...
      //################################################################################################# 
       ...
       selpar_A501_survey1_out(8)=selpar_A501_survey1; selpar_A501_survey1_out(1,7)=set_selpar_A501_survey1;
       selpar_slope1_survey1_out(8)=selpar_slope1_survey1; selpar_slope1_survey1_out(1,7)=set_selpar_slope1_survey1;
       selpar_A502_survey1_out(8)=selpar_A502_survey1; selpar_A502_survey1_out(1,7)=set_selpar_A502_survey1;
       selpar_slope2_survey1_out(8)=selpar_slope2_survey1; selpar_slope2_survey1_out(1,7)=set_selpar_slope2_survey1;
	   
       selpar_A501_fleet1_B1_out(8)=selpar_A501_fleet1_B1; selpar_A501_fleet1_B1_out(1,7)=set_selpar_A501_fleet1_B1;
       selpar_slope1_fleet1_B1_out(8)=selpar_slope1_fleet1_B1; selpar_slope1_fleet1_B1_out(1,7)=set_selpar_slope1_fleet1_B1;
       selpar_A502_fleet1_B1_out(8)=selpar_A502_fleet1_B1; selpar_A502_fleet1_B1_out(1,7)=set_selpar_A502_fleet1_B1;
       selpar_slope2_fleet1_B1_out(8)=selpar_slope2_fleet1_B1; selpar_slope2_fleet1_B1_out(1,7)=set_selpar_slope2_fleet1_B1;
       
       selpar_A501_fleet1_B2_out(8)=selpar_A501_fleet1_B2; selpar_A501_fleet1_B2_out(1,7)=set_selpar_A501_fleet1_B2;
       selpar_slope1_fleet1_B2_out(8)=selpar_slope1_fleet1_B2; selpar_slope1_fleet1_B2_out(1,7)=set_selpar_slope1_fleet1_B2;
       selpar_A502_fleet1_B2_out(8)=selpar_A502_fleet1_B2; selpar_A502_fleet1_B2_out(1,7)=set_selpar_A502_fleet1_B2;
       selpar_slope2_fleet1_B2_out(8)=selpar_slope2_fleet1_B2; selpar_slope2_fleet1_B2_out(1,7)=set_selpar_slope2_fleet1_B2;
