...
run_fims <- function(
  ...
  for (om_sim in 1:om_sim_num) {
    devtools::load_all("C:\\Users\\bai.li\\Desktop\\FIMS")
    library(FIMS)
    ...
    # # recruitment$log_rzero$value <- log(om_input$R0) * 1.2
    ...
    # # fishing_fleet_selectivity$median$value <- om_input$sel_fleet$fleet1$A50.sel1 * 1.2
    ...
    # # fishing_fleet_selectivity$slope$value <- om_input$sel_fleet$fleet1$slope.sel1 * 1.2
    ...
    # # fishing_fleet$log_Fmort <- log(om_output$f) * 1.2
    ...
    # # survey_fleet_selectivity$median$value <- om_input$sel_survey$survey1$A50.sel1 * 1.2
    ...
    # # survey_fleet_selectivity$slope$value <- om_input$sel_survey$survey1$slope.sel1 *1.2
    ...
    # # survey_fleet$log_Fmort <- rep(log(0), om_input$nyr) #-Inf?
    ...
    # # survey_fleet$log_q <- rep(log(om_output$survey_q$survey1), om_input$nyr) * 1.2
