#' @export
msy_calcs_independentF<-function(steep, R0, M, wgt, prop.f=0.5, selL, selD, selZ, mat.f=NULL, mat.m=NULL, sigma=0, brp_f_vector, om_bias_cor=FALSE, bias_cor_method=NULL, SRmodel=1, verbose=FALSE){
...
#' @export
msy_calcs_dependentF<-function(steep, R0, M, wgt, prop.f=0.5, selL, selD, selZ, mat.f=NULL, mat.m=NULL, sigma=0, brp_f_vector, om_bias_cor=FALSE, bias_cor_method=NULL, SRmodel=1, verbose=FALSE){
