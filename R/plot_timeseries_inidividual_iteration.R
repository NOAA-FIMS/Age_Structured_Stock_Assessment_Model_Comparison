#' @export
plot_timeseries_inidividual_iteration <- function(em_names, col, casedir, input_list){
  ...
  for (j in 1:length(real_figure_id)){
    jpeg(file=file.path(casedir, "figure", paste("Fig", real_figure_id[j], "_timeseries_inidividual_iteration.jpg", sep="")), width=205, height=75, units="mm", res=300)
