#' Function to generate comparison figures
#' @name generate_plot
#' @description Function to compare OM true values and EM estimates and generate comparison figures
#' @param plot_ncol Number of columns in a comparison figure
#' @param plot_nrow Number of rows in a comparison figure
#' @param plot_color Color vector to specify colors for operating model and each estimation model
#' @param input_list Name of the input data list
